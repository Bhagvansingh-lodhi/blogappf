...
>
  ← Back to Portfolio
          ...
          <p className="mt-6 text-[#667085] text-[18px] max-w-[720px] leading-[1.7]">
            Designed a Streamlined E-commerce App for Browsing and Purchasing Gadgets
          </p>
      ...
      <section className="bg-[#F7F8FE] case-tight">
        <div className="max-w-[1180px] mx-auto px-6">
          ...
          <p className="case-text-block text-[#344054] text-[18px] leading-[1.85]">
            Detailed visuals, product flows, and design decisions for Gadgetgrab will be added soon.
          </p>
        </div>
      </section>
